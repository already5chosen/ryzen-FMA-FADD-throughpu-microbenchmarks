...
uint64_t t128_fma1_add1_m9a5(float a, float b, int nIter, float* dummy)
{
  ...
  int k = nIter;
  uint64_t t0 = __rdtsc();
  do { // this test not guaranteed to be throughput-bound, because each loop is bound by latency to 27 clocks
    acc0 = _mm_fmadd_ps(aa, bb, acc0 ); acc9  = _mm_add_ps(aa, acc9 );
    acc1 = _mm_fmadd_ps(aa, bb, acc1 ); acc10 = _mm_add_ps(aa, acc10);
    acc2 = _mm_fmadd_ps(aa, bb, acc2 ); acc11 = _mm_add_ps(bb, acc11);
    acc3 = _mm_fmadd_ps(aa, bb, acc3 ); acc12 = _mm_add_ps(bb, acc12);
    acc4 = _mm_fmadd_ps(aa, bb, acc4 ); acc13 = _mm_add_ps(aa, acc13);
    acc5 = _mm_fmadd_ps(aa, bb, acc5 ); acc9  = _mm_add_ps(aa, acc9 );
    ...
    acc0 = _mm_fmadd_ps(aa, bb, acc0 ); acc13 = _mm_add_ps(aa, acc13);
    acc1 = _mm_fmadd_ps(aa, bb, acc1 ); acc9  = _mm_add_ps(aa, acc9 );
    ...
    acc6 = _mm_fmadd_ps(aa, bb, acc6 ); acc9  = _mm_add_ps(aa, acc9 );
    acc7 = _mm_fmadd_ps(aa, bb, acc7 ); acc10 = _mm_add_ps(aa, acc10);
    acc8 = _mm_fmadd_ps(aa, bb, acc8 ); acc11 = _mm_add_ps(bb, acc11);
    
    acc0 = _mm_fmadd_ps(aa, bb, acc0 ); acc12 = _mm_add_ps(bb, acc12);
    acc1 = _mm_fmadd_ps(aa, bb, acc1 ); acc13 = _mm_add_ps(aa, acc13);
    acc2 = _mm_fmadd_ps(aa, bb, acc2 ); acc9  = _mm_add_ps(aa, acc9 );
    acc3 = _mm_fmadd_ps(aa, bb, acc3 ); acc10 = _mm_add_ps(aa, acc10);
    acc4 = _mm_fmadd_ps(aa, bb, acc4 ); acc11 = _mm_add_ps(bb, acc11);
    acc5 = _mm_fmadd_ps(aa, bb, acc5 ); acc12 = _mm_add_ps(bb, acc12);
    acc6 = _mm_fmadd_ps(aa, bb, acc6 ); acc13 = _mm_add_ps(aa, acc13);
    acc7 = _mm_fmadd_ps(aa, bb, acc7 ); acc9  = _mm_add_ps(aa, acc9 );
    acc8 = _mm_fmadd_ps(aa, bb, acc8 ); acc10 = _mm_add_ps(aa, acc10);
    
    acc0 = _mm_fmadd_ps(aa, bb, acc0 ); acc11 = _mm_add_ps(bb, acc11);
    acc1 = _mm_fmadd_ps(aa, bb, acc1 ); acc12 = _mm_add_ps(bb, acc12);
    acc2 = _mm_fmadd_ps(aa, bb, acc2 ); acc13 = _mm_add_ps(aa, acc13);
    acc3 = _mm_fmadd_ps(aa, bb, acc3 ); acc9  = _mm_add_ps(aa, acc9 );
    ...
    acc8 = _mm_fmadd_ps(aa, bb, acc8 ); acc9  = _mm_add_ps(aa, acc9 );
    ...
    acc4 = _mm_fmadd_ps(aa, bb, acc4 ); acc9  = _mm_add_ps(aa, acc9 );
    acc5 = _mm_fmadd_ps(aa, bb, acc5 ); acc10 = _mm_add_ps(aa, acc10);
    acc6 = _mm_fmadd_ps(aa, bb, acc6 ); acc11 = _mm_add_ps(bb, acc11);
    acc7 = _mm_fmadd_ps(aa, bb, acc7 ); acc12 = _mm_add_ps(bb, acc12);
    acc8 = _mm_fmadd_ps(aa, bb, acc8 ); acc13 = _mm_add_ps(aa, acc13);
  } while (--k);
